...
Esta es la guía de trabajo del equipo 7. Para facilitar la colaboración se aplican varias
...
El reporte ya está armado en [`reports/`](reports/); cómo compilarlo está en el [`README.md`](README.md#reporte).
