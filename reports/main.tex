...
\title{Etapa 1. Conociendo el negocio}

\author[tec]{Jenaro Alcaraz Saragosa (A01646850)}
\author[tec]{Emilia Rico Morales (A01384587)}
\author[tec]{Mar Andrea Fern\'andez Higuera (A00227571)}
\author[tec]{Angel Eduardo Luna (A00842657)}
\author[tec]{Sof\'ia Fern\'andez V\'azquez (A01722980)}
\address[tec]{Tecnol\'ogico de Monterrey, MA2003B --- Grupo 102.07, Equipo 7}
...
\input{secciones/investigacion_obj}
\input{secciones/seleccion_datos}
\input{secciones/revi_medio_ambiente}
\input{secciones/diccionario_datos}
