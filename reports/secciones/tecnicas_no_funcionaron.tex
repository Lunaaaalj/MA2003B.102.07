...
El análisis factorial (\cref{sec:analisis-factorial}) generó, además de su resultado final,
...
reducida se sitúa en 0.06 y sobre la completa en 1.06. Con las 16,028
...
La extracción de \cref{sec:analisis-factorial} usa ejes principales iterados y no máxima
...
validó contra la implementación de referencia del paquete \texttt{psych} de R sobre el
...
una identidad, así que \cref{sec:analisis-factorial} la dejó en observación hasta que el
