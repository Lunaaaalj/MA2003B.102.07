...
plot(dens[[1]], main = "Distribucion de variables escaladas", xlab = "z-score", col = 1, xlim = xr, ylim = yr)
for (i in seq_along(dens)[-1]) lines(dens[[i]], col = i)
legend("topright", legend = cols, col = seq_along(cols), lty = 1, cex = 0.6)
```
