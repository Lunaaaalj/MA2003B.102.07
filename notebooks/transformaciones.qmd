---
title: "Transformación y escalamiento de datos"
subtitle: "Issue #35 — MA2003B, equipo 7"
lang: es
format:
  pdf:
    papersize: letter
...
png("../reports/figuras/boxplot_variables_originales.png", width = 1200, height = 800, res = 150)
boxplot(sima_horario_quant)
dev.off()
```
...
png("../reports/figuras/qqplots_variables_escaladas.png", width = 1800, height = 2200, res = 200)
graficar_qqplots()
dev.off()
```
