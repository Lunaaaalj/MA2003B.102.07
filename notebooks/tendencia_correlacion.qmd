...
# 12 variables
variables <- data %>%
  select(O3, CO, NO2, NOX, PM10, PM2.5, TOUT, PRS, WSR,
...
tabla_resumen[, c("Promedio", "Mediana", "Rango",
                  "Varianza", "Desv_Estandar")] <-
  round(tabla_resumen[, c("Promedio", "Mediana", "Rango",
                          "Varianza", "Desv_Estandar")], 3)
